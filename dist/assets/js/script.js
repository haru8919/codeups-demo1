...
(function ($) {
  ...
  $(window).on("load", function () {
    if (typeof gsap !== "undefined" && typeof ScrollTrigger !== "undefined") {
      ...
      var sectionTitles = document.querySelectorAll(".section-title__main, .section-title__sub");
      ...
      var staggerContainers = document.querySelectorAll(".blog-cards, .voice-cards");
      ...
      var textAnimElements = document.querySelectorAll(".about__content-text");
      if (textAnimElements.length > 0) {
        textAnimElements.forEach(function (el) {
          ...
          text.split("").forEach(function (_char) {
            if (_char === " " || _char === "\u3000" || _char === "\n") {
              ...
              el.innerHTML += '<span style="display:inline-block;opacity:0;transform:translateY(10px);">' + _char + '</span>';
            }
          });
      ...
      if (transitionEl) {
        ...
        if (sessionStorage.getItem('is-transitioning')) {
          ...
          var blockingStyle = document.getElementById('transition-blocking-style');
          if (blockingStyle) {
