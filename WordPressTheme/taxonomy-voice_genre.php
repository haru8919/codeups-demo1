...
<section id="#" class="common-mv">
    <div class="common-mv__inner">
        <div class="common-mv__img">
            <picture>
                <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/common/voice_mv-pc.jpg"
                    media="(min-width:1025px)" />
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/common/voice_mv-sp.jpg"
            ...
            <div class="page-voice__category-wrap">
                <div class="category">
                    <ul class="category__items">
                        <!-- ALL リンク -->
                        <li class="category__item <?php if (!is_tax('voice_genre')) echo 'active'; ?>">
                        ...
                        <?php
                                ...
                                if (!empty($terms) && !is_wp_error($terms)) :
                                    foreach ($terms as $term) :
                                        ...
                                        $active_class = (is_tax('voice_genre', $term->slug)) ? 'active' : '';
                                ?>
