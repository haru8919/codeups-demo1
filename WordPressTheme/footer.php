            ...
            <div class="footer__top-wrap">
                ...
                <div class="footer__top-box">
                    <a href="#"><img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/facebook-logo.svg"
                            alt="ファイスブックアイコン" class="footer__icon-facebook" /></a>
                    <a href="#"><img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/Instagram-logo.svg"
                            alt="インスタグラムアイコン" class="footer__icon-instagram" /></a>
                </div>
            </div>
        </div>
